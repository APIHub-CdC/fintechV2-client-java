package io.RCCPM.interceptor;

import com.google.gson.Gson;
import io.RCCPM.client.model.Errors;
...
import io.RCCPM.client.model.Error;
...
public class SignerInterceptor implements Interceptor {
	...
	private Request procesarFirmado(Request originalRequest) {
		...
		if (originalRequest.method() == "GET") {
			logger.info(originalRequest.url().encodedQuery()); 
			System.out.println(originalRequest.url().encodedPathSegments()); 
			System.out.println(pathSegments.get(pathSegments.size()-1));
